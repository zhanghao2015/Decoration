...
public class MyFragment extends BaseFragment  {
    ...
    Button loginbtn;
    Activity activity;
    @BindView(R.id.user_circular)
    ImageView userCircular;
    @BindView(R.id.makeCold)
    Button makeCold;
    @BindView(R.id.mymoneypack)
    Button mymoneypack;
    @BindView(R.id.dingdan)
    ImageView dingdan;
    @BindView(R.id.riji)
    ImageView riji;
    @BindView(R.id.myrizi)
    RelativeLayout myrizi;
    @BindView(R.id.talk)
    ImageView talk;
    @BindView(R.id.mytalk)
    ...
    ImageView advance;
    @BindView(R.id.myadvance)
    RelativeLayout myadvance;
    @BindView(R.id.tousu)
    ImageView tousu;
    @BindView(R.id.mytousu)
    RelativeLayout mytousu;
    @BindView(R.id.contact)
    ImageView contact;
    @BindView(R.id.mykefu)
    RelativeLayout mykefu;
    @BindView(R.id.setting)
    ImageView setting;
    @BindView(R.id.mysetting)
    RelativeLayout mysetting;
    @BindView(R.id.conversionIv)
    ImageView conversionIv;
